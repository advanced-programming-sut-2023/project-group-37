...
public enum TroopType {
    ...
    //LORD:
    LORD("", new Image(Objects.requireNonNull(TroopType.class.getResource
            ("/Image/troop/lord.png")).toExternalForm()), null, 0, 100,
            100, 55, 1, null, null, false, false),

    // Barracks:
    ARCHER("archer", new Image(Objects.requireNonNull(TroopType.class.getResource
            ("/Image/troop/european/archer.png")).toExternalForm()), BuildingType.BARRACKS, 12, 45,
            40, 90, 10, Item.BOW, null, true, true),
    SPEARMAN("spearman", new Image(Objects.requireNonNull(TroopType.class.getResource
            ("/Image/troop/european/spearman.png")).toExternalForm()), BuildingType.BARRACKS, 8, 50,
            50, 60, 1, Item.SPEAR, null, true, true),
    MaceMan("maceman", new Image(Objects.requireNonNull(TroopType.class.getResource
    ...
    CROSSBOWMAN("crossbowman", new Image(Objects.requireNonNull(TroopType.class.getResource
    ...
    PIKEMAN("pikeman", new Image(Objects.requireNonNull(TroopType.class.getResource
            ("/Image/troop/european/pikeman.png")).toExternalForm()), BuildingType.BARRACKS, 20, 77,
            76, 60, 1, Item.PIKE, Item.METAL_ARMOR, false, true),
    SWORDSMAN("swordsman", new Image(Objects.requireNonNull(TroopType.class.getResource
    ...
    KNIGHT("knight", new Image(Objects.requireNonNull(TroopType.class.getResource
