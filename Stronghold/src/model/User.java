...
public class User {
    ...
    public void setPasswordRecoveryQuestion(int questionNumber) {
    ...
    public boolean checkPasswordRecoveryAnswer(String passwordRecoveryAnswer) {
        return this.passwordRecoveryAnswer.matches("\\s*" + passwordRecoveryAnswer + "\\s*");
    }
