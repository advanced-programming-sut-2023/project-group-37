...
public enum TroopType {
    ...
    TroopType(int speed, int maxHitPoints, int attackingDamage, int defencingDamage) {
    ...
    TroopType(int speed, int maxHitPoints, int attackingDamage, int defencingDamage, Weapons... weapons) {
